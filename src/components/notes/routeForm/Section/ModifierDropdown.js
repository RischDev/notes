    ...
    render() {
        ...
        if (this.props.itemValue != null) {
            if (Items.Items[this.props.itemValue] == null) {
                if (this.props.type === "text") {
                    return(
                        <select name={"textModifier-" + this.props.sectionId + "-" + this.props.textId} className={`${styles.select}`} value={this.props.value} onChange={this.onChange}>
                            <option value=""> </option>
                        </select>
                    );
                } else if (this.props.type === "section") {
                    return(
                        <select name={"sectionModifier-" + this.props.sectionId + "-" + this.props.itemId} className={`${styles.select}`} value={this.props.value} onChange={this.onChange}>
                            <option value=""> </option>
                        </select>
                    );
                }
